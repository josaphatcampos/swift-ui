            ...
            ZStack {
                ...
                VStack {
                    ...
                    ZStack{
                        ...
                        Capsule()
                            .fill(Color("ColorRed").opacity(0.2)).padding(8)
                        Text("Descubra mais")
                            .font(.title2)
                            .bold()
                            .foregroundColor(Color("ColorRedDark"))
                        ...
                        .gesture(
                            DragGesture()
                                .onChanged({ gesture in
                                    if(gesture.translation.width >= 0 && gesture.translation.width < (geometry.size.width - 60) - buttonHeight){
                                        withAnimation(.easeInOut(duration: 0.5)){
